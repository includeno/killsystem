...
public class KafkaConsumerConfig {
    ...
    @Bean
    public Map<String, Object> consumerObjectConfigs() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
    ...
    kafkaObjectListenerContainerFactory() {
        DefaultKafkaConsumerFactory<Object, Object> para = new DefaultKafkaConsumerFactory<>(consumerObjectConfigs());
        ConcurrentKafkaListenerContainerFactory<Integer, Object> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(para);
        factory.setConcurrency(3);
        factory.getContainerProperties().setPollTimeout(3000);
        return factory;
    }
