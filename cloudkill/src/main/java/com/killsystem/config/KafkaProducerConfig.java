...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<Integer, Object> producerObjectFactory() {
        return new DefaultKafkaProducerFactory<>(producerObjectConfigs());
    }

    @Bean
    public KafkaTemplate<Integer, Object> kafkaObjectTemplate() {
        return new KafkaTemplate<Integer, Object>(producerObjectFactory());
    }
}
